...
const UserReward = require('../../models/pg/index').UserReward;
...
const userRewardRepository = {
  async create_user_reward(reward) {
    try {
      ...
      const promotion_ref = await Promotion.findOne({ where: { id: reward.promotion_id } });
      ...
      await user_reward_ref.update({ reward_limit: promotion_ref.promotion_limit });
